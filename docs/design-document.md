...
İlk MVP alıştırmaları:

- Kart çevirme: Arapça form -> anlam
- Çoktan seçmeli: verilen şahsa doğru çekimi seç
...
- Ana sayfa
- Ders listesi
- Bir ders detay ekranı
- İnteraktif çekim tablosu prototipi
- En az bir alıştırma tipi
- Kaynak ekranı
- Örnek veri seti: `نصر` fiili üzerinden mâzi ve muzâri
